...
std::shared_ptr<Entity> EntityManager::addEntity(eEntitiesType entityType, eLevelEntities entityTag) {
    // creat the entity shared pointer
    auto entity = std::shared_ptr<Entity>(new Entity(entityType, entityTag));
